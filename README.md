...
Sistema web de inventario, usuarios y consulta de medicamentos. Para instalarlo en un servidor propio, consulta `INSTALACION_SERVIDOR.md`.

## Nota sobre integraciones

La búsqueda automática de precios reales y la atención mediante WhatsApp requieren credenciales y servicios externos. No se incluyen claves privadas en este paquete.
